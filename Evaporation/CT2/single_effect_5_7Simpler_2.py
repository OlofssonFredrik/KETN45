...
def evaporator(X):
    ...
    Y[7]=k2*A*(T1-T2) - V1*(HV1-hk2)      #EB för heat ex 2
    ...
    Y[11]=k3*A*(T2-T3) - V2*(HV2-hk3)       #EB för heat ex 3
...
if not sol.success:
    ...
    print('Overall heat transfer coefficient for 1',k2,'kW/m^2*K')
    print('Overall heat transfer coefficient for 1',k3,'kW/m^2*K')
